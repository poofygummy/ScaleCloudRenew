...
/* HEADLESS: AppDelegate is app-level, not available in headless framework. Only the two backup notification constants are needed.
import UIKit
...
/* HEADLESS: keeping only appBackupDidFinish and appBackupResultKey */
class AppDelegate
{
